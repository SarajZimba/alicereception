...
load_dotenv()
app_file32 = Blueprint('app_file32',__name__)
from root.auth.check import token_auth
from root.utils.converttoJson import listtojson
from root.utils.returnJson import successmsg,errormsg


@app_file32.route("/getFinalizedByName", methods=["POST"])
@cross_origin()
def getFinalizedbyName():
    try:
